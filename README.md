...
> SQL has not been tested. The application is not runnable end-to-end.
...
- parsed-AST policy checks (**Slices 1–2 structure policy implemented**;
  schema-aware authorization pending);
